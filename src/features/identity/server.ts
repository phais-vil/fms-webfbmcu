...
export { resolvePalette, getTenantPalette, getTenantSettings, resolveTenantBrand } from "./_internal/services/tenant.service";
export type { TenantBrandInfo } from "./_internal/services/tenant.service";
